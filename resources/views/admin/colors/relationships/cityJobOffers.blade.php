...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-colorJobOffers">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.jobOffer.fields.color') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-colorJobOffers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
