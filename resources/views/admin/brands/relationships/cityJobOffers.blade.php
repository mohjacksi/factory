...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-brandJobOffers">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.jobOffer.fields.brand') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-brandJobOffers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
