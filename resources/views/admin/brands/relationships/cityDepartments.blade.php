...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-brandDepartments">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.department.fields.brand') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-brandDepartments:not(.ajaxTable)').DataTable({ buttons: dtButtons })
