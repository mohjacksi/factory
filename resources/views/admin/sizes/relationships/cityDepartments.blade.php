...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-sizeDepartments">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.department.fields.size') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-sizeDepartments:not(.ajaxTable)').DataTable({ buttons: dtButtons })
