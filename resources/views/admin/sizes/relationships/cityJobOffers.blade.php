...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-sizeJobOffers">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.jobOffer.fields.size') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-sizeJobOffers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
