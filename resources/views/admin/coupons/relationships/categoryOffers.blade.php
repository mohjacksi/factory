...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-couponOffers">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.offer.fields.coupon') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-couponOffers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
