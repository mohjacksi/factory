...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-couponNews">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.news.fields.coupon') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-couponNews:not(.ajaxTable)').DataTable({ buttons: dtButtons })
