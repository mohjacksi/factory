...
@section('content')
        ...
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                <a class="btn btn-success" href="{{ route('admin.sub_categories.create') }}">
                    {{ trans('global.add') }} {{ trans('cruds.sub_category.title_singular') }}
                </a>
            </div>
        </div>
    @endcan
    <div class="card">
        <div class="card-header">
            {{ trans('cruds.sub_category.title_singular') }} {{ trans('global.list') }}
        </div>
...
{{--                        {{ trans('cruds.sub_category.fields.category_id') }}--}}
                        {{ trans('cruds.sub_category.fields.category_name') }}
                    </th>
                </tr>
                <tr>
                    <td>
        ...
        $(function () {
            ...
            let dtOverrideGlobals = {
                ...
                columns: [
                    ...
                    {data: 'id', name: 'id'},
                    {data: 'name', name: 'name'},
                    {data: 'category_name', name: 'category.name',searchable: true},
                ],
                orderCellsTop: true,
                order: [[1, 'desc']],
                pageLength: 50,
