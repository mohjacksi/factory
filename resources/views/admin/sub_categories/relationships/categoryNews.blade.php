...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-sub_categoryNews">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.news.fields.sub_category') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-sub_categoryNews:not(.ajaxTable)').DataTable({ buttons: dtButtons })
